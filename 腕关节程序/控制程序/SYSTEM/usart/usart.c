...
int openPacket()
{
	...
	else if( 4 == sscanf(PktBuf,"POSE ALL %f %f %f %f",&motorPOS0,&motorPOS1,&motorPOS2,&motorPOS3) )
	{
					...
					ConfigMotorCMD(&motorCMD[0] , POS, motorPOS0, motorCMD[0].A,motorCMD[0].Offset,motorCMD[0].Fq,motorCMD[0].phi);
					ConfigMotorCMD(&motorCMD[1] , POS, motorPOS1, motorCMD[1].A,motorCMD[1].Offset,motorCMD[1].Fq,motorCMD[1].phi);
					ConfigMotorCMD(&motorCMD[2] , POS, motorPOS2, motorCMD[2].A,motorCMD[2].Offset,motorCMD[2].Fq,motorCMD[2].phi);
					ConfigMotorCMD(&motorCMD[3] , POS, motorPOS3, motorCMD[3].A,motorCMD[3].Offset,motorCMD[3].Fq,motorCMD[3].phi);
											
					printf("\r\n cmd :");
					printf("\r\n POSE #ALL \n");
	}
	else if( 1 == sscanf(PktBuf,"SET LAMBDA %f",&lambda) )
	{
